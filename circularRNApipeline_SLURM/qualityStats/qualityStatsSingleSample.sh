...
module load python/2.7.5  ## SPECIFIC TO OUR CLUSTER, required to use more recent version of python than the default
...
if [ $# -eq 7 ]
then
  JUNC_DIRNAME=junction$7
  OUTF=SampleAlignmentStats$7.txt
  OUT_READS=SampleCircularStats$7.txt
else
